...
14. [Settings — Media Processing](userguide/04-settings.md#settings--media-processing)
    - [Face Recognition](userguide/04-settings.md#face-recognition)
    - [Document Processing (OCR & Image Extraction)](userguide/04-settings.md#document-processing-ocr--image-extraction)
