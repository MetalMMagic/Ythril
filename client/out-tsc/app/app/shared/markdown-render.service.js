...
export class MarkdownRenderService {
    ...
    async render(text) {
        ...
        let html = md.parse(text, { async: false });
    ...
    static { this.ɵfac = function MarkdownRenderService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || MarkdownRenderService)(); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: MarkdownRenderService, factory: MarkdownRenderService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(MarkdownRenderService, [{
        type: Injectable,
