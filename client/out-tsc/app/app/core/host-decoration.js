 ...
 */
export function hostSuppliesDecoration(root = document.documentElement) {
    try {
 ...
 */
export function applyHostDecoration(root = document.documentElement) {
