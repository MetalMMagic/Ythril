    ...
    try {
      ...
      switch (name) {
        ...
        case 'remember': {
          ...
          const remMeta = _remMetaRaw ? resolveMetaRefs(_remMetaRaw, getConfig().schemaLibrary) : undefined;
        ...
        case 'upsert_entity': {
          ...
          const entMeta = _entMetaRaw ? resolveMetaRefs(_entMetaRaw, getConfig().schemaLibrary) : undefined;
        ...
        case 'upsert_edge': {
          ...
          const edgeMeta = _edgeMetaRaw ? resolveMetaRefs(_edgeMetaRaw, getConfig().schemaLibrary) : undefined;
        ...
        case 'create_chrono': {
          ...
          const chronoMeta = _chronoMetaRaw ? resolveMetaRefs(_chronoMetaRaw, getConfig().schemaLibrary) : undefined;
        ...
        case 'bulk_write': {
          ...
          const bwMeta = _bwMetaRaw ? resolveMetaRefs(_bwMetaRaw, getConfig().schemaLibrary) : undefined;
